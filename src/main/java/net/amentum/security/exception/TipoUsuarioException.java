...
public class TipoUsuarioException extends GenericException {
    ...
    public TipoUsuarioException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public TipoUsuarioException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
