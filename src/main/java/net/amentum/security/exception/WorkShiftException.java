...
public class WorkShiftException extends GenericException {
    ...
    public WorkShiftException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public WorkShiftException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
